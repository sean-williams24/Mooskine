...
class NotebooksListViewController: UIViewController, UITableViewDataSource {
    ...
    // Fetched results controller needs to be specialized to the type of object it returns
    ...
    func addNotebook(name: String) {
        // create new notebook associated with the data controllers view context
    ...
    func deleteNotebook(at indexPath: IndexPath) {
        ...
        // Delete notebok from and save change to persistent store
