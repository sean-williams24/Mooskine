...
class NotesListViewController: UIViewController, UITableViewDataSource {
    ...
    fileprivate func setupFetchedResultsController() {
        ...
        // Create predicate to include only those notes related to the selected notebook
        ...
        do {
            ...
            fatalError("There was an error fetching data: \(error.localizedDescription)")
        }
    }
...
extension NotesListViewController: NSFetchedResultsControllerDelegate {
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange sectionInfo: NSFetchedResultsSectionInfo, atSectionIndex sectionIndex: Int, for type: NSFetchedResultsChangeType) {
        ...
        case .update, .move: fatalError("Invalid change type in controller(_:didChange:atSectionindex:for. Only .insert and .delete are possible.")
        @unknown default:
            fatalError()
        }
    }
